            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="main_action1.php" method="post">
  			 ...
  			 <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="name" id="name" required class="form-control">
                                        ...
                                        <?php
                                        $sqlquery = "SELECT * FROM teacher_reg";
                                        $result = mysqli_query($con, $sqlquery);
                                        
                                            while ($display = mysqli_fetch_array($result)){     
                                        ?>
                                        <option value="<?php  echo $display['reg_id'];?>"><?php echo $display['name_of_teacher'];?>-<?php echo $display['department'];?></option>
                                    <?php
                                }
                                ?>
                                    </select>
